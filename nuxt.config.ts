...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://massageathome24h.com/' },
        { property: 'og:image', content: 'https://massageathome24h.com/images/og-image.jpg' },
        ...
        // { name: 'twitter:site', content: '@massageathome24h' }, // Thay @massageathome24h bằng username Twitter của bạn
        // { name: 'twitter:creator', content: '@massageathome24h' }, // Thay @massageathome24h bằng username Twitter của bạn
        ...
        // { name: 'twitter:image', content: 'https://massageathome24h.com/images/og-image.jpg' },
      ],
      link: [
  ...
  i18n: {
    defaultLocale: 'vi',
    baseUrl: 'https://massageathome24h.com',
    locales: [
  ...
  site: {
    url: 'https://massageathome24h.com',
